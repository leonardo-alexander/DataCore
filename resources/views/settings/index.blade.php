            ...
            <section id="faq" data-spy="faq" class="scroll-mt-24 rounded-2xl border border-slate-200/70 bg-white p-6 shadow-card">
                ...
                @php
                    $faqs = [
                        ...
                        ['q' => __('How do I sell my survey? What is the order of steps?'),                        'a' => __('Selling always follows the same order: end it, clean it, then sell it. 1) End the survey — open My Collections, use the ⋯ menu on the collection and choose "End survey". This closes it to new responses and refunds the reward pool you did not use. 2) Clean the data — run Half Clean (free). You cannot publish before this: it strips personal information and scores the quality. Full Clean is optional and paid, and produces a deduplicated, fully typed dataset that sells for more. 3) Sell it — open Edit Collection, set a price, switch the status to For sale, and save. It appears in the marketplace right away.')],
                        ['q' => __('Why can I not switch my collection to For sale?'),                             'a' => __('Publishing is locked until Half Clean has been run on the entries, so no uncleaned personal data can reach the marketplace. If the option is refused, end the survey first, run Half Clean from Edit Collection, then set the status to For sale. A collection with no entries cannot be cleaned, and so cannot be sold.')],
                        ['q' => __('Do I have to end the survey before I clean and sell it?'),                     'a' => __('Ending it first is strongly recommended. You can run Half Clean while a survey is still collecting, but any response that arrives afterwards stays raw, so the dataset your buyer downloads would be a mix of cleaned and uncleaned rows. Ending the survey freezes the data set, refunds the unused reward pool, and gives you one clean pass over everything.')],
